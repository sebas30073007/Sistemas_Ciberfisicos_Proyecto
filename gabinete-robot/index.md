...
| **Módulo de recepción de residuos** | - PLC Siemens LOGO! y señales de salida.<br>- Puerta automática con actuador lineal y su coordinación con el resto del sistema. |
...
| **Red de comunicaciones y cómputo** | - Topología de la red local: PC central y switch Ethernet.<br>- Conexiones ethernet que enlazan los diferentes microprocesadores y módulos de control. |
...
- Las conexiones eléctricas se describen con el nombre real de los puertos y, cuando aplica.
